...
services = [
    ...
    {"name":"hive",
     ...
     "actions":[{"name":"initdb","display":"初始化数据库","tooptip":""},
                {"name":"initsearch","display":"安装huesearch","tooptip":"安装hue search"},
                {"name":"start","display":"启动","tooptip":""},
                {"name":"stop","display":"停止","tooptip":""},
                {"name":"restart","display":"重启","tooptip":""},
                {"name":"check","display":"检查","tooptip":"执行简单查询,检查impala是否可用。"}
     ...
     {"name":"search",
     "role":["solrserver","hbaseindexer"],
     "actions":[{"name":"initsolr","display":"格式化","tooptip":"格式化zolr的ZK的配置"},
                {"name":"start","display":"启动","tooptip":""},
                {"name":"stop","display":"停止","tooptip":""},
                {"name":"restart","display":"重启","tooptip":""},
                ], 
     "instanceActions":[{"name":"start","display":"启动","tooptip":""},
                        ...
                        {"name":"restart","display":"重启","tooptip":""}],
     "dependence" : ["hdfs"],
     "web" : [{"role":"solrserver","port":"solr_port"}]
     },
     {"name":"client",
