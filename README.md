...
5.  安装本地库(可选)
    ...
    *如果你不熟悉以下操作，可以跳过*
	...
	如果,网络状况太差，下载失败。可以使用我们准备好的[uhp_repo.tar.gz](http://pan.baidu.com/share/link?shareid=3415691721&uk=486905787)包，直接在HTTP服务的本地根目录解压即可。
